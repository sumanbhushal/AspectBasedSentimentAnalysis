import config, database, product_aspects_extraction, pre_processing, opinion_extraction, msc, pos_tagging, aspect_pruning, n_grams
import nltk
...
def main():
    ...
    # Stopword
    # noun_list_without_stopwords = pre_processing.filter_stopwords(noun_verb)
    ...
    # print(len(candidate_aspect_list),candidate_aspect_list)
